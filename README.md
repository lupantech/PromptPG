...
--embedding_size 128 \
--model_config bert-base-uncased \
--ckpt exp1_rl/ckpt_best_reward.pt \
--gpu 0
```

It will generate the predictions and save the results at `results/gpt3_rl/exp1_rl_inf2_test_TQ-SA_2_seed_1.json`.

For the few-shot GPT-3 model, we repeated the experiments with four different random seeds of 1, 2, 3, and 4, and report the average accuracy of the top 3 results.
...
--result_files exp10_rl_inf2_test_TQ-SA_2_seed_1.json
```

You can report the average result over multiple result files as we do in the paper:

```sh
python evaluate_acc.py \
--data_file data/tabmwp/problems_test.json \
--result_root results/gpt3_rl \
--result_files "exp10_rl_inf2_test_TQ-SA_2_seed_1.json, exp25_rl_inf2_test_TQ-SA_2_seed_2.json, exp55_rl_inf2_test_TQ-SA_2_seed_4.json"
```
...
Similarly,  we repeated the experiments with four different random seeds of 1, 2, 3, and 4, and report the average accuracy of the top 3 results.
...
Similarly, we repeat the experiments with four different random seeds of 1, 2, 3, and 4, and report the average accuracy of the top 3 results.
