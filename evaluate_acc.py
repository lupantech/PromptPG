...
if __name__ == "__main__":
    ...
    parser.add_argument('--result_root', type=str, default="results/gpt3_rl")
    parser.add_argument('--result_files', type=str, default="exp10_rl_inf2_test_TQ-SA_2_seed_1.json")
